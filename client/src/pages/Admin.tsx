      ...
      <div className="admin-grid">
        <section className="admin-card admin-form-card">
          ...
          <form onSubmit={saveItem} className="admin-form">
            ...
            <label>Image URL <span className="field-muted">optional</span><input value={form.imageUrl} onChange={(event) => setForm({ ...form, imageUrl: event.target.value })} placeholder="/manus-storage/…" /><span className="field-help"><ImageIcon size={13} /> Use a WebDev storage path for menu photography.</span></label>
